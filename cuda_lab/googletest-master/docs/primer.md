...
class FooTest : public ::testing::Test {
 protected:
  ...
  FooTest() {
     // You can do set-up work for each calendar_tests here.
  }
  ...
  // and cleaning up each calendar_tests, you can define the following methods:

  void SetUp() override {
     // Code here will be called immediately after the constructor (right
     // before each calendar_tests).
  }

  void TearDown() override {
     // Code here will be called immediately after each calendar_tests (right
     // before the destructor).
  }

  // Class members declared here can be used by all tests in the calendar_tests suite
  // for Foo.
};

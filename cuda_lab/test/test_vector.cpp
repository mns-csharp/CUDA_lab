 ...
 **/
    ASSERT_EQ(get_(products1, 3, 0, 0), 3); ASSERT_EQ(get_(products1, 3, 0, 1), 4); ASSERT_EQ(get_(products1, 3, 0, 2), 5);
    ASSERT_EQ(get_(products1, 3, 1, 0), 6); ASSERT_EQ(get_(products1, 3, 1, 1), 8); ASSERT_EQ(get_(products1, 3, 1, 2), 10);
}
